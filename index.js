...
//console.table(busquedasInc('log((sin(x))^2 + 1)-1/2',-3,0.5,100).iterations)
//console.table(biseccion('log((sin(x)^2)+ 1)-1/2',0,1,1e-7,100).iterations)
//console.table(reglaFalsa('log((sin(x)^2)+ 1)-1/2',0,1,1e-7,100).iterations)
//console.table(puntoFijo('log((sin(x)^2)+1)-x-1/2','log((sin(x)^2)+1)-1/2',-0.5,1e-7,100).iterations)
//console.table(newton('log((sin(x)^2)+ 1)-1/2','2/(((sin(x)^2)+1))*sin(x)*cos(x)',0.5,1e-7,100).iterations)
//console.table(secante('log((sin(x)^2)+ 1)-1/2',0.5,1,1e-7,100).iterations)
//console.table(raicesMultiples('e^x-x-1','e^x-1','e^x',1,1e-7,100).iterations)
